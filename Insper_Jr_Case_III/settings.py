"""
Django settings for Insper_Jr_Case_III project.
...
SECRET_KEY = 'django-insecure-g3_*5gkr_ibp_$ot^d36%gw^8)z*q68+!w9t(funaggn(rse%e'
...
ROOT_URLCONF = 'Insper_Jr_Case_III.urls'
...
WSGI_APPLICATION = 'Insper_Jr_Case_III.wsgi.application'
